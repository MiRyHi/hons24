...
setwd("D:/Mitch/Documents/Honours/Project/Network_analysis/Tp1-8_Tn1-8/IGRP_Tp1-8_Tn1-8_data/TETpos")
...
setwd("D:/Mitch/Documents/Honours/Project/Network_analysis/Tp1-8_Tn1-8/IGRP_Tp1-8_Tn1-8_data/CD8")
...
setwd("D:/Mitch/Documents/Honours/Project/Network_analysis/Tp1-8_Tn1-8")
...
# Remove the old dataframes with "-" in their names

rm(`CD8-1`, `CD8-2`, `CD8-3`, `CD8-4`, `CD8-5`, `CD8-6`, `CD8-7`, `CD8-8`)
rm(`TETpos-1`, `TETpos-2`, `TETpos-3`, `TETpos-4`, `TETpos-5`, `TETpos-6`, `TETpos-7`, `TETpos-8`)


exp <- rbind(CD8_1, CD8_2, CD8_3, CD8_4, CD8_5, CD8_6, CD8_7, CD8_8, TETpos_1, TETpos_2, TETpos_3, TETpos_4, TETpos_5, TETpos_6, TETpos_7, TETpos_8)
...
write.csv(network_table, "Cytoscape_inputs/Cytoscape__TETpos_75.csv", row.names = FALSE, quote = FALSE)
