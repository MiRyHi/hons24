...
training_object_name = 'IGRP_WF_45_Mc_Tp1-8_Tn1-8_0_cut'        #change to name of folder within 'Supervised_WF' that you have set up with this name format, where 'Train', 'Kf', 'Mc' are codes for the type of training, followed by _ and then the name of the training data folder (without IGRP_ at the beginning)
